...
MIGRATION_COMMANDS = {
        ...
        'ecommerce':     "source {env_file}; {python} {code_dir}/manage.py migrate --noinput --db-dry-run --merge",
        'insights':      "source {env_file}; {python} {code_dir}/manage.py migrate --noinput --db-dry-run --merge",
        'analytics_api': "source {env_file}; {python} {code_dir}/manage.py migrate --noinput --db-dry-run --merge"
    }
